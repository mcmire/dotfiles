...
" When scrolling vertically, it's hard to see the cursor when it's at the very
" top or bottom of the window, especially on large screens. So we set a vertical
