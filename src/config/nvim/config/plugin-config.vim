...
call s:load_file("astro")
call s:load_file("auto-pairs")
call s:load_file("coc")
call s:load_file("colorizer")
call s:load_file("copilot")
...
call s:load_file("lists")
call s:load_file("markdown-preview")
call s:load_file("neco-ghc")
call s:load_file("nerdcommenter")
call s:load_file("nerdtree")
call s:load_file("nvim-miniyank")
call s:load_file("prolog-syntax-vim")
