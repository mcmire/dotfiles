...
-- Also, this is a straight port of the Vimscript code because I got lazy;
-- simplify and edit
...
-- want to use dark mode most of the time. But you may find yourself outdoors
-- and in this case light mode may be more handy. So we provide a way to switch
...
function refresh_color_scheme(color_scheme_mode)
